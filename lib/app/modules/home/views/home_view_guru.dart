...
class HomeGuruView extends GetView<HomeController> {
  static final bottomController = Get.put<BottomNavController>(
    BottomNavController(),
  );
  const HomeGuruView({super.key});
  @override
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  progressSection(
                    progressValue: 0.5, // Example progress value
                    title: 'Progress Siswa', // Example title
                    description:
                        'Semua Siswa telah menyelesaikan 50% dari modul.', // Example description
                  ),
                  SizedBox(height: MediaQuery.of(context).size.height * 0.03),
                  statsSection(materialCount: 30, studentCount: 30),
                  SizedBox(height: MediaQuery.of(context).size.height * 0.03),
                  Padding(
                    padding: EdgeInsets.symmetric(
...
Widget progressSection({
  ...
  Color backgroundColor = const Color.fromARGB(255, 190, 224, 231),
  Color progressBarColor = const Color.fromARGB(255, 31, 35, 162),
  Color progressBarBackgroundColor = const Color.fromARGB(255, 147, 153, 216),
}) {
  return Padding(
...
Widget statsSection({
  ...
  Color backgroundColor = const Color.fromARGB(255, 190, 224, 231),
  Color iconColor = const Color.fromARGB(255, 31, 35, 162),
}) {
  return Padding(
    padding: const EdgeInsets.symmetric(horizontal: 15),
    child: Container(
      ...
      child: Row(
        ...
        children: [
          Column(
            ...
            children: [
              Icon(Icons.group, color: iconColor, size: 30),
              SizedBox(height: 8),
              Text(
                'Jumlah Siswa',
                style: TextStyle(
          ...
          Column(
            crossAxisAlignment: CrossAxisAlignment.center,
            children: [
              Icon(Icons.book, color: iconColor, size: 30),
              SizedBox(height: 8),
              Text(
                'Jumlah Pertemuan',
                style: TextStyle(
